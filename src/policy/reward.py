...
class RewardFunction:
    ...
    def compute(self, obs: dict, action: np.ndarray) -> dict:
        ...
        r_grasp = self._grasp(reach_dist, grasped)
    ...
    def _grasp(self, reach_dist: float, grasped: bool) -> float:
        """Flat bonus when EE is close enough and object is grasped."""
        if reach_dist < self.reach_gate_dist and grasped:
            return self.w_grasp
        return 0.0
